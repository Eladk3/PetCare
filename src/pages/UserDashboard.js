...
const UserDashboard = () => {
  ...
  return (
    <Box sx={{ p: 3, color: 'primary.contrastText' }}>
      <Typography 
        variant="h3" 
        gutterBottom 
        sx={{ 
          color: { xs: 'text.primary', dark: 'white' }, 
          fontWeight: 'bold' 
        }}
      >
        DASHBOARD
      </Typography>
      <Typography variant="h6" gutterBottom sx={{ color: '#55AD9B', fontWeight: 'bold' }}>
        Welcome to your Dashboard!
      </Typography>
      <Grid container spacing={2} sx={{ mt: 2 }}>
        <Grid item xs={12} md={4}>
          <Paper elevation={3} sx={{ p: 2, textAlign: 'center', bgcolor: 'cream', color: 'primary' }}>
            <Avatar
